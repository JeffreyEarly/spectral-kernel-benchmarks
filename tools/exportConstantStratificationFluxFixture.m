...
manifest = struct( ...
    ...
    "normalization",struct("horizontalForward","raw FFT coefficients followed by 1/(Nx*Ny) during modal projection","horizontalInverse","raw inverse FFT with 0.5 type-I inverse factors during coefficient assembly","pointwiseScale",1/double((matlabTransform.Nx*matlabTransform.Ny)^2),"verticalForward","REDFT00/RODFT00 divided by Nz-1 with DCT top endpoint halved and DST endpoints zero"), ...
