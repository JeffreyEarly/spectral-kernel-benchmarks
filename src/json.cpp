...
void writeJson(const BenchmarkReport& report, const std::filesystem::path& path) {
    ...
    stream << "  \"logicalOperators\":{\"horizontalForward\":\"T_h^+=P_h F_xy\",\"horizontalInverse\":\"T_h^-=F_xy^-1 E_h\",\"verticalForward\":\"T_z^+=V_f\",\"verticalInverse\":\"T_z^-=V_i\",\"verticalFixtureId\":\"orthonormal-dct2-truncated-v1\",\"resultKey\":\"(k,l,j,field)\"},\n";
    stream << "  \"workload\":{\n";
