...
void usage(std::ostream& output) {
    output << "Usage:\n"
           ...
           << "  skbench run [--kernel fft|pruned-horizontal|vertical-gemm|ordering-packing|spectral-boundary|spectral-pipeline|production-lifetime-flux|constant-stratification-vertical|dealiased-convolution|vertically-batched-advection] [--profile NAME] [--providers both|fftw] [--workers N]\n"
